...
def toolCitationText() {
    ...
    def text_classification = [
            ...
            params.run_gtdbtk     ? "GTDB-Tk (Chaumeil et al. 2019).": "",
        "."
    ].join(' ').trim()
    ...
    def citation_text = [
        ...
        [params.run_bracken, params.run_kraken2, params.run_krakenuniq, params.run_metaphlan, params.run_malt, params.run_diamond, params.run_centrifuge, params.run_kaiju, params.run_motus, params.run_ganon, params.run_kmcp, params.run_gtdbtk].any() ?
            text_classification : "",
...
def toolBibliographyText() {
    ...
    def text_classification = [
        ...
        params.run_gtdbtk     ? "<li>Chaumeil, P.-A., Mussig, A. J., Hugenholtz, P., & Parks, D. H. (2019). GTDB-Tk: a toolkit to classify genomes with the Genome Taxonomy Database. Bioinformatics , 36(6), 1925–1927. <a href=\"https://doi.org/10.1093/bioinformatics/btz848\">10.1093/bioinformatics/btz848</a></li>" : "",
    ].join(' ').trim()
